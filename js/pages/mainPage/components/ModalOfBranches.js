    ...
    openModal() {
        ...
        <i class="branches-modal__close-icon">
            ...
            <div class="branches-modal__container">
                <img src="assets/images/branches/chalus.jpg" class="active active-item"/>
                <img src="assets/images/branches/vanak.jpg"/>
                <img src="assets/images/branches/aghdasieh.jpg"/>
                <img src="assets/images/branches/ekbatan.jpg"/>
            </div>
        </div>
        `;
    }
